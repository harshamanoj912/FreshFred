    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCommissionRateNow.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                ...
                totalIncomeHistory_forRiders.setText(Objects.requireNonNull(snapshot.child("totalRiderCommission").getValue()).toString() + " LKR") ;
                totalIncomeHistory_forYou.setText(Objects.requireNonNull(snapshot.child("forOwner").getValue()).toString() + " LKR") ;
